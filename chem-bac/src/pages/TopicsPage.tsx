            ...
            <div className="filter-bar">
                ...
                <div style={{ width: 200 }}>
                    <CustomSelect
                        ...
                        value={filterCat}
                        onChange={(val) => setFilterCat(val as TopicCategory | '')}
                        options={[
                            { value: '', label: 'Orice categorie' },
                            ...Object.entries(TOPIC_CATEGORY_LABELS).map(([k, v]) => ({ value: k, label: v }))
                        ]}
                    />
                </div>
                <div style={{ width: 160 }}>
                    <CustomSelect
                        ...
                        value={filterDiff}
                        onChange={(val) => setFilterDiff(val as TopicDifficulty | '')}
                        options={[
